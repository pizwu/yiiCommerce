 ...
 */
class ProductAttributeMultilingual extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ProductAttributeMultilingual the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, attribute_id, language_id, name', 'safe', 'on'=>'search'),
		);
	}
