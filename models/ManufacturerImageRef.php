...
/**
 * This is the model class for table "tbl_manufacturer_image_ref".
 *
 * The followings are the available columns in table 'tbl_manufacturer_image_ref':
 * @property integer $id
...
class ManufacturerImageRef extends CActiveRecord
{
	...
	{
		return 'tbl_manufacturer_image_ref';
	}
