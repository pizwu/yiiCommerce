...
/**
 * This is the model class for table "osc_product_multilingual".
 *
 * The followings are the available columns in table 'osc_product_multilingual':
 * @property integer $id
...
class ProductMultilingual extends CActiveRecord
{
	...
	{
		return 'osc_product_multilingual';
	}
