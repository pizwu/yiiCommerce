 ...
 */
class CategoryMultilingual extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CategoryMultilingual the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, category_id, language_id, name', 'safe', 'on'=>'search'),
		);
	}
