...
class ProductAttribute extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'productAttributeMultilinguals' => array(self::HAS_MANY, 'ProductAttributeMultilingual', 'attribute_id'),
			'productAttributeValues' => array(self::HAS_MANY, 'ProductAttributeValue', 'attribute_id'),
		);
	}
