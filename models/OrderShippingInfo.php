...
/**
 * This is the model class for table "{{order_shipping_info}}".
 *
 * The followings are the available columns in table '{{order_shipping_info}}':
 * @property integer $id
 ...
 */
class OrderShippingInfo extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return OrderShippingInfo the static model class
	 */
