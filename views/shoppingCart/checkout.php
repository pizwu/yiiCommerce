...
<form id="checkout" method="post" action="<?php echo CHtml::normalizeUrl(array("shoppingCart/checkout")) ?>">
	...
	<div id="accordion">
		...
		<div id="shipping-info">
			<input type="hidden" value="<?php echo $addressBook->id ?>" name="shipping[address_book_id]" />
			
			<h4>Company Info</h4>
			<label for="shipping-company">Company</label>
			<input type="text" id="shipping-company" name="shipping[company]" value="<?php echo $addressBook->company ?>" /><br />
		
			<label for="shipping-first-name">First name *</label>
			<input type="text" id="shipping-first-name" name="shipping[first_name]" value="<?php echo $addressBook->first_name ?>" required /><br />
		
			<label for="shipping-last-name">Last name *</label>
			<input type="text" id="shipping-last-name" name="shipping[last_name]" value="<?php echo $addressBook->last_name ?>" required /><br />
			
			<label for="shipping-phone">Phone *</label>
			<input type="phone" id="shipping-phone" name="shipping[phone]" value="<?php echo $addressBook->phone ?>" required /><br /><br />
		
			<h4>Address Info</h4>
			<label for="shipping-street-address">Street address *</label>
			<input type="text" id="shipping-street-address" name="shipping[street_address]" value="<?php echo $addressBook->street_address ?>" size="80" required /><br />
		
			<label for="shipping-postcode">Post code *</label>
			<input type="text" id="shipping-postcode" name="shipping[postcode]" value="<?php echo $addressBook->postcode ?>" required /><br />
		
			<label for="shipping-city">City *</label>
			<input type="text" id="shipping-city" name="shipping[city]" value="<?php echo $addressBook->city ?>" required /><br />
		
			<!-- <label for="shipping-state">State</label>
			<input type="text" id="shipping-state" name="shipping[state]" value="<?php echo $addressBook->state ?>" /><br /> -->
		
			<label for="shipping-country">Country *</label>
			<input type="text" id="shipping-country" name="shipping[country]" value="<?php echo $addressBook->country ?>" required /><br />
		</div>
